...
Citizen.CreateThread(function()
    while true do
        ...
        if IsInRegularShopZone(coords) or IsInRobsLiquorZone(coords) or IsInYouToolZone(coords) or IsInPrisonShopZone(coords) or IsInInetShopZone(coords) or IsInSexShopZone(coords) or IsInLTDgasolineZone(coords) or IsInVendingZone(coords) then
...
Citizen.CreateThread(function()
    ...
    for k, v in pairs(Config.Shops.RegularShop.Locations) do
        CreateBlip(vector3(Config.Shops.RegularShop.Locations[k].x, Config.Shops.RegularShop.Locations[k].y, Config.Shops.RegularShop.Locations[k].z ), "7-Eleven", 3.0, Config.Color, Config.ShopBlipID)
    end

    for k, v in pairs(Config.Shops.RobsLiquor.Locations) do
        CreateBlip(vector3(Config.Shops.RobsLiquor.Locations[k].x, Config.Shops.RobsLiquor.Locations[k].y, Config.Shops.RobsLiquor.Locations[k].z ), "Systembolaget", 3.0, Config.Color, Config.LiquorBlipID)
    end

    for k, v in pairs(Config.Shops.YouTool.Locations) do
        CreateBlip(vector3(Config.Shops.YouTool.Locations[k].x, Config.Shops.YouTool.Locations[k].y, Config.Shops.YouTool.Locations[k].z ), "Biltema", 3.0, 38, Config.YouToolBlipID)
    end
    --[[
    ...
    for k, v in pairs(Config.Shops.LTDgasoline.Locations) do
        CreateBlip(vector3(Config.Shops.LTDgasoline.Locations[k].x, Config.Shops.LTDgasoline.Locations[k].y, Config.Shops.LTDgasoline.Locations[k].z), "OKQ8", 3.0, Config.Color, Config.ShopBlipID)
    end
    ...
    while true do
        ...
        for k, v in pairs(Config.Shops.RegularShop.Locations) do
            if GetDistanceBetweenCoords(coords, Config.Shops.RegularShop.Locations[k].x, Config.Shops.RegularShop.Locations[k].y, Config.Shops.RegularShop.Locations[k].z, true) < 3.0 then
                ESX.Game.Utils.DrawText3D(vector3(Config.Shops.RegularShop.Locations[k].x, Config.Shops.RegularShop.Locations[k].y, Config.Shops.RegularShop.Locations[k].z + 1.0), "Tryck ~g~[E]~w~ för att handla", 0.6)
            end
        end
        ...
        for k, v in pairs(Config.Shops.RobsLiquor.Locations) do
            if GetDistanceBetweenCoords(coords, Config.Shops.RobsLiquor.Locations[k].x, Config.Shops.RobsLiquor.Locations[k].y, Config.Shops.RobsLiquor.Locations[k].z, true) < 3.0 then
                ESX.Game.Utils.DrawText3D(vector3(Config.Shops.RobsLiquor.Locations[k].x, Config.Shops.RobsLiquor.Locations[k].y, Config.Shops.RobsLiquor.Locations[k].z + 1.0), "Tryck ~g~[E]~w~ för att handla", 0.6)
            end
        end
        ...
        for k, v in pairs(Config.Shops.YouTool.Locations) do
            if GetDistanceBetweenCoords(coords, Config.Shops.YouTool.Locations[k].x, Config.Shops.YouTool.Locations[k].y, Config.Shops.YouTool.Locations[k].z, true) < 3.0 then
                ESX.Game.Utils.DrawText3D(vector3(Config.Shops.YouTool.Locations[k].x, Config.Shops.YouTool.Locations[k].y, Config.Shops.YouTool.Locations[k].z + 1.0), "Tryck ~g~[E]~w~ för att handla", 0.6)
            end
        end
        ...
        for k, v in pairs(Config.Shops.PrisonShop.Locations) do
            if GetDistanceBetweenCoords(coords, Config.Shops.PrisonShop.Locations[k].x, Config.Shops.PrisonShop.Locations[k].y, Config.Shops.PrisonShop.Locations[k].z, true) < 3.0 then
                ESX.Game.Utils.DrawText3D(vector3(Config.Shops.PrisonShop.Locations[k].x, Config.Shops.PrisonShop.Locations[k].y, Config.Shops.PrisonShop.Locations[k].z), "Tryck ~g~[E]~w~ för att handla", 0.6)
            end
        end
        ...
        for k, v in pairs(Config.Shops.LTDgasoline.Locations) do
            if GetDistanceBetweenCoords(coords, Config.Shops.LTDgasoline.Locations[k].x, Config.Shops.LTDgasoline.Locations[k].y, Config.Shops.LTDgasoline.Locations[k].z, true) < 3.0 then
                ESX.Game.Utils.DrawText3D(vector3(Config.Shops.LTDgasoline.Locations[k].x, Config.Shops.LTDgasoline.Locations[k].y, Config.Shops.LTDgasoline.Locations[k].z), "Tryck ~g~[E]~w~ för att handla", 0.6)
            end
        end
